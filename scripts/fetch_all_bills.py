...
SNAPSHOT_DIR = DATA_DIR / "sync"  # NEW: snapshot directory
...
def fetch_bills_from_legiscan() -> List[Dict]:
    ...
    bills = []
    try:
        # Placeholder for a real LegiScan fetch. Instead we use curated "actual_bills".
        actual_bills = [
...
def main():
    ...
    # Ensure data directory exists
    ensure_data_dir()
    ensure_sync_dir()  # NEW: make sure snapshot directory exists
